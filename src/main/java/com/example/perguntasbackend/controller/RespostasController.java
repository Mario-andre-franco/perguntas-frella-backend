...
public class RespostasController {
    ...
    @PostMapping("/salvar-respostas-por-categoria/usuario/{idUsuario}/pergunta/{idPergunta}")
    public ResponseEntity<Resposta> salvarRespostasCategoria(@PathVariable Long idUsuario, @PathVariable Long idPergunta, @RequestBody Resposta resposta) {
        ...
        */
        ...
        if(idResposta.equals(idCorreto)) {
            respostaService.atualizaPontosCategoria(usuarioExiste);
            return ResponseEntity.status(HttpStatus.CREATED).build();
        }
